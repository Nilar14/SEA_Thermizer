...
```{r}
# Creating Ocean_temp_array - using the data created in the rmarkdown "Avg_temp_data_create.Rmd" and combining it for model runs .


# Load the data 

r1_ctrl <- readRDS("GFDL_CTRL_THETA_0to300_ave.rds")
r2_ctrl <- readRDS("GFDL_CTRL_THETA_0to500_ave.rds")
r3_ctrl <- readRDS("GFDL_CTRL_THETA_0to400_ave.rds")
r4_ctrl <- readRDS("GFDL_CTRL_THETA_100to700_ave.rds")
r5_ctrl <- readRDS("GFDL_CTRL_THETA_200to1100_ave.rds")
r6_ctrl <- readRDS("GFDL_CTRL_THETA_150to800_ave.rds")
r7_ctrl <- readRDS("GFDL_CTRL_THETA_400to1000_ave.rds")
r8_ctrl <- readRDS("GFDL_CTRL_THETA_400to800_ave.rds")
r9_ctrl <- readRDS("GFDL_CTRL_THETA_400to600_ave.rds")
r10_ctrl <- readRDS("GFDL_CTRL_THETA_100to800_ave.rds")
r11_ctrl <- readRDS("GFDL_CTRL_THETA_100to400_ave.rds")
r12_ctrl <- readRDS("GFDL_CTRL_THETA_50to300_ave.rds")
r13_ctrl <- readRDS("GFDL_CTRL_THETA_150to400_ave.rds")
r14_ctrl <- readRDS("GFDL_CTRL_THETA_50to500_ave.rds")
r15_ctrl <- readRDS("GFDL_CTRL_THETA_50to400_ave.rds")



# Create a coulmn of all the realm names 
...
# Fill the array by combing all the above data 

Ocean_temp_realm_array[,] <- cbind(r1_ctrl[,2], r2_ctrl[,2], r3_ctrl[,2], r4_ctrl[,2], r5_ctrl[,2], r6_ctrl[,2], r7_ctrl[,2], r8_ctrl[,2], r9_ctrl[,2], r10_ctrl[,2], r11_ctrl[,2], r12_ctrl[,2], r13_ctrl[,2], r14_ctrl[,2], r15_ctrl[,2])


#write.table(Ocean_temp_realm_array, file = "SEAus_Ocean_temp_realm_array.dat", quote = FALSE, row.names = TRUE, col.names = TRUE)

#saveRDS(Ocean_temp_realm_array, "Ocean_temp_realm_array.rds")
